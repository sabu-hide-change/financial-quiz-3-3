    ...
    renderQuestionImage: () => (
      <div className="my-4 p-4 bg-slate-900 rounded-xl border border-slate-700 flex justify-center overflow-x-auto shadow-lg">
        <svg viewBox="0 0 500 200" className="w-full max-w-lg min-w-[400px]">
          ...
          {/* 日数のパラメータを補完してSVGテキストとしてマッピング */}
          <g fill="#94a3b8" fontSize="12" fontWeight="bold">
            <text x="80" y="60" fill="#ef4444">A(8)</text>
            <text x="80" y="145">B(4)</text>
            <text x="200" y="60" fill="#ef4444">D(6)</text>
            <text x="180" y="140">E(8)</text>
            <text x="200" y="185">F(5)</text>
            <text x="300" y="90" fill="#ef4444">H(12)</text>
            <text x="300" y="190">G(7)</text>
            <text x="410" y="145">J(3)</text>
          </g>
    ...
    renderQuestionImage: () => (
      <div className="my-4 p-4 bg-slate-900 rounded-xl border border-slate-700 overflow-x-auto shadow-lg">
        <svg viewBox="0 0 500 220" className="w-full max-w-lg min-w-[400px] mx-auto">
          ...
          {/* 日数のパラメータを補完してSVGテキストとしてマッピング */}
          <g fill="#94a3b8" fontSize="12" fontWeight="bold">
            <text x="80" y="60" fill="#ef4444">A(10)</text>
            <text x="200" y="30" fill="#ef4444">D(15)</text>
            <text x="310" y="60" fill="#ef4444">G(20)</text>
            <text x="400" y="100" fill="#ef4444">H(25)</text>

            <text x="100" y="100">B(10)</text>
            <text x="200" y="135">E(20)</text>

            <text x="80" y="160">C(10)</text>
