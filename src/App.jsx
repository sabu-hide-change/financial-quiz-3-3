  ...
  },
  {
    ...
    renderQuestionImage: () => (
      <div className="my-4 p-4 bg-slate-900 rounded-xl border border-slate-700 flex justify-center overflow-x-auto shadow-lg">
        <svg viewBox="0 0 500 200" className="w-full max-w-lg min-w-[400px]">
          <defs>
          ...
          <g stroke="#818cf8" strokeWidth="2" fill="none" markerEnd="url(#arrow)">
            <line x1="50" y1="100" x2="150" y2="40" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* A */}
            <line x1="50" y1="100" x2="150" y2="160" /> {/* B */}
            <line x1="150" y1="40" x2="250" y2="100" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* D */}
            <line x1="150" y1="160" x2="250" y2="100" /> {/* E */}
            <line x1="150" y1="160" x2="250" y2="180" /> {/* F */}
            <line x1="250" y1="100" x2="350" y2="100" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* H */}
            <line x1="250" y1="180" x2="350" y2="160" /> {/* G */}
            <line x1="350" y1="160" x2="450" y2="100" /> {/* J */}
          </g>
          <g fill="#94a3b8" fontSize="12" fontWeight="bold">
            <text x="80" y="60" fill="#ef4444">A</text>
            <text x="80" y="145">B</text>
            <text x="200" y="60" fill="#ef4444">D</text>
            <text x="180" y="140">E</text>
            <text x="200" y="185">F</text>
            <text x="300" y="90" fill="#ef4444">H</text>
            <text x="300" y="190">G</text>
            <text x="410" y="145">J</text>
          </g>
          <g fill="#1e293b" stroke="#3b82f6" strokeWidth="2" fontSize="12">
            <circle cx="50" cy="100" r="14" />
            <text x="50" y="104" fill="#f8fafc" textAnchor="middle" stroke="none">1</text>
            
            <circle cx="150" cy="40" r="14" stroke="#ef4444" />
            <text x="150" y="44" fill="#f8fafc" textAnchor="middle" stroke="none">2</text>
            
            <circle cx="150" cy="160" r="14" />
            <text x="150" y="164" fill="#f8fafc" textAnchor="middle" stroke="none">3</text>
            
            <circle cx="250" cy="100" r="14" stroke="#ef4444" />
            <text x="250" y="104" fill="#f8fafc" textAnchor="middle" stroke="none">4</text>
            
            <circle cx="250" cy="180" r="14" />
            <text x="250" y="184" fill="#f8fafc" textAnchor="middle" stroke="none">5</text>
            
            <circle cx="350" cy="160" r="14" />
            <text x="350" y="164" fill="#f8fafc" textAnchor="middle" stroke="none">6</text>
            
            <circle cx="450" cy="100" r="14" stroke="#ef4444" />
            <text x="450" y="104" fill="#f8fafc" textAnchor="middle" stroke="none">7</text>
          </g>
          <text x="250" y="215" fill="#64748b" fontSize="10" textAnchor="middle">※解説文から再現したアローダイアグラム（赤線はクリティカルパスA→D→H）</text>
        </svg>
      </div>
    ),
    options: [
...
ノード3の最早着手日は作業Bと同じ4日です。一方、最遅着手日はクリティカルパス上にあるノード4から、作業Eの8日を引いた6日となります。よって記述は適切です。`
  },
  {
    ...
    renderQuestionImage: () => (
      <div className="my-4 p-4 bg-slate-900 rounded-xl border border-slate-700 overflow-x-auto shadow-lg">
        <svg viewBox="0 0 500 220" className="w-full max-w-lg min-w-[400px] mx-auto">
          <defs>
            <marker id="arrow" markerWidth="8" markerHeight="8" refX="22" refY="4" orient="auto">
              <path d="M0,0 L8,4 L0,8 Z" fill="#818cf8" />
            </marker>
          ...
          <g stroke="#818cf8" strokeWidth="2" fill="none" markerEnd="url(#arrow)">
            <line x1="50" y1="110" x2="150" y2="40" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* A */}
            <line x1="150" y1="40" x2="250" y2="40" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* D */}
            <line x1="250" y1="40" x2="350" y2="110" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* G */}
            <line x1="350" y1="110" x2="450" y2="110" stroke="#ef4444" markerEnd="url(#arrow-crit)" /> {/* H */}

            <line x1="50" y1="110" x2="150" y2="110" /> {/* B */}
            <line x1="150" y1="110" x2="250" y2="180" /> {/* E(20) */}

            <line x1="50" y1="110" x2="150" y2="180" /> {/* C */}
            <line x1="150" y1="180" x2="250" y2="180" /> {/* F(25) */}
          </g>
          <g fill="#94a3b8" fontSize="12" fontWeight="bold">
            <text x="80" y="60" fill="#ef4444">A</text>
            <text x="200" y="30" fill="#ef4444">D</text>
            <text x="310" y="60" fill="#ef4444">G</text>
            <text x="400" y="100" fill="#ef4444">H</text>

            <text x="100" y="100">B</text>
            <text x="200" y="135">E(20)</text>

            <text x="80" y="160">C</text>
            <text x="200" y="170">F(25)</text>
          </g>
          <g fill="#1e293b" stroke="#3b82f6" strokeWidth="2" fontSize="12">
            <circle cx="50" cy="110" r="14" />
            <text x="50" y="114" fill="#f8fafc" textAnchor="middle" stroke="none">1</text>
            
            <circle cx="150" cy="40" r="14" stroke="#ef4444" />
            <text x="150" y="44" fill="#f8fafc" textAnchor="middle" stroke="none">?</text>
            
            <circle cx="150" cy="110" r="14" />
            <text x="150" y="114" fill="#f8fafc" textAnchor="middle" stroke="none">2</text>
            <text x="150" y="90" fill="#fbbf24" stroke="none" fontWeight="bold" textAnchor="middle">最遅 X?</text>

            <circle cx="150" cy="180" r="14" />
            <text x="150" y="184" fill="#f8fafc" textAnchor="middle" stroke="none">3</text>
            <text x="150" y="210" fill="#fbbf24" stroke="none" fontWeight="bold" textAnchor="middle">最遅 Y?</text>

            <circle cx="250" cy="180" r="14" />
            <text x="250" y="184" fill="#f8fafc" textAnchor="middle" stroke="none">5</text>
            <text x="285" y="195" fill="#94a3b8" stroke="none" fontSize="10">最遅=70</text>
            
            <circle cx="350" cy="110" r="14" stroke="#ef4444" />
          </g>
          <text x="250" y="15" fill="#64748b" fontSize="10" textAnchor="middle">※解説文の条件から再現したアローダイアグラム</text>
        </svg>
      </div>
    ),
    options: [
  ...
  },
  {
    ...
    renderQuestionImage: () => (
      <div className="my-4 overflow-x-auto rounded-lg border border-slate-700">
        ...
        <p className="text-xs text-slate-500 p-2 text-right">※解説内容から再構築した参考データ</p>
      </div>
    ),
    options: [
      "220万円",
  ...
  },
  {
    ...
    renderQuestionImage: () => (
      <div className="my-4 overflow-x-auto rounded-lg border border-slate-700">
        ...
        <p className="text-xs text-slate-500 p-2 text-right">※解説文より抜粋された部分表</p>
      </div>
    ),
    options: [
      "50分",
...
●生産座席予約方式
・概要：受注時に、製造設備の使用日程や資材の使用予定などにオーダーを割り付ける方式。飛行機や電車の座席を予約するようなイメージ。
